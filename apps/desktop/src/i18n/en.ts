...
export const en: Translations = {
  ...
  settings: {
    ...
    usagePage: {
      ...
      noProviders: 'No signed-in providers.',
    ...
    providers: {
      ...
      addSubscription: 'Add another subscription',
      rotation: 'Rotation',
      rotationFillFirst: 'Use first until exhausted',
      rotationRoundRobin: 'Cycle evenly',
      rotationLeastUsed: 'Least used',
      rotationRandom: 'Random',
      poolEmpty: 'No extra subscriptions yet. The connected account is the one desktop sign-in saved.',
