...
- **Supported browsers:** Chrome, Edge, Brave, Brave Origin, Chromium, and Dia on macOS
  (whichever is your OS default). A non-Chromium default (e.g. Firefox) fails closed with a clear
